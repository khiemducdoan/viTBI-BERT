...
from data_loaderlatefusion import ViTBERT # Adjust the import statement according to your project structure
from modellatefusion import ViTBERTClassifier # Adjust the import statement according to your project structure
...
class ViTBERTTrainer:
    ...
    def train_epoch(self, dataloader):
        ...
        for batch in tqdm(dataloader, desc="Training"):
            input_ids1,attention_mask1 ,input_ids2,attention_mask2 ,labels,text1,text2 = batch[0].to(self.device),batch[1].to(self.device),batch[2].to(self.device),batch[3].to(self.device),batch[4].to(self.device),batch[5],batch[6]
            labels = labels.long()
    ...
    def train(self):
        ...
        for fold, (train_ids, test_ids) in enumerate(kfold.split(self.dataset)):
            ...
            save_path = f'./after-model-fold-{fold}.pt'
